...
#ifndef EXAMPLES_ANALYTICAL_APPS_LCCDP_LCCDP_H_
#define EXAMPLES_ANALYTICAL_APPS_LCCDP_LCCDP_H_
...
class LCCDPContext : public grape::VoidContext<FRAG_T> {
 public:
  ...
  void Output(std::ostream& os) override {
    ...
    *true_degree = (size_t*) malloc(iv.size() * sizeof(size_t));
    ...
    *weight = (char*) malloc(edge_size * sizeof(char));
    for (auto v : vertices) {
      auto& nbrs = complete_neighbor[v];
...
#endif  // EXAMPLES_ANALYTICAL_APPS_LCCDP_LCCDP_H_
